...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_path", help="path of images", type=str, required=False, default="/data2/ljq/do_train/stable-diffusion/fake_image")
    parser.add_argument(
        "--class_to_forget", help="class_to_forget", type=int, required=False, default=1
    )
    parser.add_argument(
        "--image_size",
