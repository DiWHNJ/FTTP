...
def convert_ldm_clip_checkpoint(checkpoint):
    text_model = CLIPTextModel.from_pretrained("/datanfs2/dmz/clip-vit-large-patch14-336")
...
def convert_paint_by_example_checkpoint(checkpoint):
    config = CLIPVisionConfig.from_pretrained("/datanfs2/dmz/clip-vit-large-patch14-336")
