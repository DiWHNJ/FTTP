    ...
    for epoch in range(epochs):
        with tqdm(total=len(forget_dl)) as t:
            for i in range(len(forget_dl)):
                ...
                forget_images, forget_labels,forget_mask = next(iter(forget_dl))
                remain_images, remain_labels,remain_mask = next(iter(remain_dl))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_method", help="method of training", type=str, default="full",
    )
    parser.add_argument(
        "--alpha",
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="/data2/ljq/do_train/stable-diffusion/models/ldm/stable-diffusion-v1/sd-v1-4-full-ema.ckpt",
    )
    parser.add_argument(
        "--mask_path",
    ...
    # python train-scripts/gradient_ascent.py --ckpt_path 'models/ldm/stable-diffusion-v1/sd-v1-4-full-ema.ckpt' --class_to_forget" 1 --device '0'